...
charset = UTF-8' . "\r\n";
                ...
                $message .= "<p>" . site_url('index.php/annonce/' . url_title(convert_accented_characters($statut->getVal()), '-', true) . '/' . url_title(convert_accented_characters($type->getVal()), '-', true) . '/' . url_title(convert_accented_characters($sous_region->getRegion()->getVal()), '-', true) . '/' . url_title(convert_accented_characters($sous_region->getVal()), '-', true) . '/' . url_title(convert_accented_characters($posts['titre_fr']), '-', true) . '-' . $annonce->getId_ann()) . "</p>";
