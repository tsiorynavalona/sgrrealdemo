...
/**
 * Description of Infos_utiles
 *
 * @author mrandria
 */
class Infos_utiles extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->lang->load('info_utile', $this->session->userdata('site_lang'));
    ...
    public function index() {
        ...
        $data['contents'] = 'content/infos_utiles';
