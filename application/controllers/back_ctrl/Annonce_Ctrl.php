...
class Annonce_Ctrl extends CI_Controller {
    ...
    public function index($page = null) {
        ...
        if ($this->session->userdata('admin') != null) {
           ...
           //var_dump($this->Annonce_Model->getAll('french'));die;
    ...
    public function rechercher() {
        ...
        if ($this->session->userdata('admin') != null && !empty($posts)) {
            $this->_data['annonces'] = $this->Annonce_Model->getByRef($posts['reference'], 'french', 1);
            $this->_data['contents'] = 'back_content/index';
            $this->_data['sous_menu_actif'] = "Bien";
            $this->ChargerPage($this->_data);
        } else {
    ...
    public function detail($id=null) {
        ...
        if ($this->session->userdata('admin') != null) {
            ...
            $this->_data['sous_menu_actif'] = "Bien";
            $this->ChargerPage($this->_data);
			//$this->load->view('back_content/detail_estimation');
    ...
    public function update_annonce() {
        ...
        foreach ($posts['id_icone'] as $key => $id_icone) {
            ...
            if ($id_icone == '3') {//surface
                if (isset($posts['id_mesure']) && !empty($posts['id_mesure'])) {
			...
			if ($id_icone == '4') {//surface
                if (isset($posts['id_mesure2']) && !empty($posts['id_mesure2'])) {
...
//        var_dump($cpt);
        ...
        foreach ($posts['id_icone'] as $key => $id_icone) {
            ...
            $temp->setVal_icone($posts['val_icone'][$key]);
            if ($id_icone == 3) {//surface
				$surfaceval = $posts['val_icone'][$key];
                if (isset($posts['id_mesure']) && isset($posts['id_mesure']) != '') {
                    $mesure = new Mesure();
					$annonce->setMeasure_Terrin($posts['id_mesure']);
                    $mesure->setId_mesure($posts['id_mesure']);
                    $temp->setMesure($mesure);
...
if ($id_icone == '4') {//surface
        ...
        $s = $this->Annonce_Model->save($annonce);
        ...
        if ($is_alert != false) {
            foreach ($is_alert as $alert) {
               // $to = $alert->getEmail();
				...
				if($posts['prix'] >= $alert->getPrix_min() && $posts['prix'] <= $alert->getPrix_max() ){
...
charset = UTF-8' . "\r\n";
    ...
    public function delete_car($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Caracteristique');
    }
    ...
    public function delete_agent($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Agent');
    }
...
//        exit;
    ...
    public function delete_tag($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Tags');
    }
    ...
    public function delete_statut($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Statut');
    }
    ...
    public function delete_client($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Client');
    }
    ...
    public function delete_devise($id) {
        if ($this->session->userdata('admin') != null) {
            ...
            redirect('back_ctrl/Annonce_Ctrl/Devise');
        } else {
            $this->load->view('back_content/login');
        }
    }
    ...
    public function delete_region($id) {
        ...
        redirect('back_ctrl/Annonce_Ctrl/Lieu');
    }

    public function delete_sousregion($id) {
    ...
    public function delete_statut_type($id) {
