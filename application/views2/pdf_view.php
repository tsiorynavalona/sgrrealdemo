...
<div>
    ...
    <p><img src="<?php echo base_url('assets/images/' . $annonce->getImagePrincipal()); ?>" width="798" height="425"></p>

    <?php
    foreach ($images as $key => $image) {
        ?>
        <img src="<?php echo base_url('assets/images/' . $image->getNom_image()); ?>" width="169" height="100">
        <span> </span>
        <?php
    }
    ?>
...
$pdf->Output('RPC-' . $annonce->getTitre_annonce() . '.pdf', 'I');
