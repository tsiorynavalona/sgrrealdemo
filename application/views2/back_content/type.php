                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($types as $type) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/detail_type/' . $type->getId_type()); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/delete_type/' . $type->getId_type()); ?>">
