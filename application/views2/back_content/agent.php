                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($agents as $agent) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/modifAgent/' . $agent->getId_agent()); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/delete_agent/' . $agent->getId_agent()); ?>">
