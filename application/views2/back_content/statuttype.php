                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($statut_type as $stat_type) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/detail_statut_type/' . $stat_type->getId_statut_type()); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/delete_statut_type/' . $stat_type->getId_statut_type()); ?>">
