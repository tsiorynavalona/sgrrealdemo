                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($devises as $devise) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/detail_devise/' . $devise->getId_devise()); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/delete_devise/' . $devise->getId_devise()); ?>">
