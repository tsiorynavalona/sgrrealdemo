                ...
                <div class = "header">
                    <div class = "row">
                        <div class = "col-xs-6 col-lg-3 to_hide">
                            <div class = "logo">
                                <a href = "<?php echo base_url(); ?>"><img src = "<?php echo base_url('assets/images/logo.png') ?>"  alt = "RPC-Real Estate logo"/></a>
                            </div>
                        </div>
                        <div class = "col-xs-6 col-lg-3 to_show">
                            <div class = "logo">
                                <img src = "<?php echo base_url('assets/images/logo.png') ?>" alt = "RPC-Real Estate logo"/>
                            </div>
                        </div>
                        <div class = "col-xs-6 col-lg-9 to_hide">
                            <!-- <div class="row hide-on-small">
                                ...
                                <div class = "top-header-right col-sm-6">
                                    <img src = "<?php echo base_url('assets/images/top-right.jpg') ?>" alt = "RPC-Real Estate Maurice"/>
                                </div>
                            </div> -->
                            ...
                            <div class = "collapse navbar-collapse" id="responsiveNavBar">
                                ...
                                <ul class="nav navbar-nav">
                                            ...
                                            <div class="dropdown-content">
                                                ...
                                                foreach ($statut_type as $type) {
                                                    if ($statut->getId_statut() == $type->getId_statut()) {
                                                        ?>
                                                        <a href="<?php echo site_url("menu/" . url_title(convert_accented_characters($statut->getVal()), '-', true) . "/" . url_title(convert_accented_characters($type->getVal_type()), '-', true) . "-" . $type->getId_type() . "-" . $statut->getId_statut()) ?>"><?php echo $type->getVal_type(); ?></a>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                    ...
                                    <li class="">
                                        <a href="<?php echo site_url($url_infos_utiles); ?>" class="dropbtn"><?php echo('&nbsp;&nbsp;&nbsp; |  &nbsp;&nbsp;&nbsp;'.strtoupper($information)); ?></a>
                                    </li>
                                    <li class=" ">
                                        <a href="<?php echo site_url($url_notre_agence); ?>" class="dropbtn"><?php echo('&nbsp;&nbsp;&nbsp; |  &nbsp;&nbsp;&nbsp;'.strtoupper($notre_agence )); ?></a>

                                    </li>
                                    <li class="">
                                        <a href="<?php echo site_url('contact'); ?>" class="contact-menu " ><?php echo strtoupper('Contact'); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
