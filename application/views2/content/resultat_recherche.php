<div class="container">
    <div class="main-container">
        <div class="col-sm-12 col-md-12 col-lg-9" >
                ...
                <form action="<?php echo site_url() ?>/index/recherche_multicritere" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="surface_min"  id="surface_min" class="input-custom">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="surface_max"  id="surface_max" class="input-custom">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
            ...
            <br>
            <div id='estimer_link'> <h4><a style="text-decoration: underline" href='<?php echo site_url($url_estimate_property) ?>'>+ <?php echo $estimer_bien; ?></a></h4></div>
            <br>
            <br>
                            ...
                            <div class="col-sm-4">
                                <div class="desc">
                                    ...
                                    if ($devise->getLeft_symbole() == "1") {
                                        ?>
                                        <h5 ><span class="ul-bleu">Prix : </span> <b class="ul-bleu"><?php
