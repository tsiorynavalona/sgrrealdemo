...
color:#fff; background: url(http://www.rpc-ea.com/assets/images/banner.jpg) no-repeat center center fixed; padding-top:100px; 
font-size:24px; text-align:center; background-size: cover; text-shadow: 2px 2px #000;">
	<?php
		if($this->session->userdata('site_lang') == "english"){
			echo 'Your trust and our experience <br> for successful transactions!';
		}else{
			echo 'Votre confiance et notre expérience <br> pour des transactions réussies !';
		}
	?>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <?php } else {
                                                ...
                                                <label class="type-bien-place"><?php
                                                    ...
                                                    echo money_format($annonce->getPrix()) . " " . $devise->getSymbole();
                                                    if ($annonce->getPar_mois()) {
                                                        ?> /  <?php
                                                        echo $mois;
                                                    }
