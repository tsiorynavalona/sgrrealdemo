...
<html>
    <head>
        ...
        <title>SGR Agence Immobilier</title>
		...
		<link rel = "stylesheet" type = "text/css" href = "<?php echo base_url('data_table/dataTables.bootstrap.min.css') ?>" />
        <!-- Google Font -->
                            ...
                            <li class="dropdown user user-menu">
                                <div class="dropdown">
                                    ...
                                    <div id="myDropdown" class="dropdown-content">
                                        <a href="<?php echo str_replace("?", "", site_url('back_ctrl/index/logout')) ?>" >Déconnexion</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <li class="<?php if ('Bien' == $menu_actif) echo "active"; ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <?php foreach ($menu as $key => $value): ?>
                                    ...
                                    <li class="<?php if ($value == $sous_menu_actif) echo "active"; ?> ">
