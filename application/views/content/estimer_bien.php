    ...
    <div class="main-container">
        <div class="col-sm-12 col-md-12 col-lg-9">
            <div class="echantillon2">
                <div class="div-title"><?php echo $estimer_bien; ?></div>
                <?php if (isset($msg)) { ?>
                ...
                <form method="POST" action="<?php echo str_replace("?", "", site_url()); ?>/estimer_bien/envoyer">
                    <div class="form">
                        <h4><?php echo $info_perso; ?></h4>
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <h5><?php echo $nom_complet; ?></h5>
                                <input name="nom" type="text" class="input-custom">
                            </div>
                            <div class="col-sm-6">
                                <h5>Email</h5>
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <h5>Fax</h5>
                                <input type="text" name="fax" class="input-custom">
                            </div>
                            <div class="col-sm-6">
                                <h5>Telephone</h5>
                                <input type="text" name="telephone"  class="input-custom">
                            </div>
                        </div>
                    </div>
                    <div class="form">
                        <h4><?php echo $your_property; ?></h4>
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <h5><?php echo $type_de_bien; ?></h5>
                                <div class="select">
                                    <select name="type">
                                        <option disabled selected></option>
                                        <?php foreach ($types as $type) { ?>
                                            <option value="<?php echo $type->getVal(); ?>"><?php echo $type->getVal(); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="select" >
                                    <select name="sousregion" style="width: 100%;">
                                            ...
                                            <optgroup label="<?php echo $region->getVal(); ?>">
                                                ...
                                                foreach ($sousregions as $sousregion) {
                                                    ...
                                                    if ($reg->getId_region() == $region->getId_region()) {
                                                        ?>
                                                        <option value="<?php echo $sousregion->getVal(); ?>"><?php echo $sousregion->getVal(); ?></option>
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <h5><?php echo $surface; ?> (m2)</h5>
                                <input type="text" name="surface" class="input-custom">
                            </div>
                            <div class="col-sm-6">
                                <h5><?php echo $nb_piece; ?></h5>
                                <input type="text" name="nb_piece" class="input-custom">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-12">
                                <h5><?php echo $your_message; ?></h5>
                                <textarea name="desc" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    <p>* <?php echo $required_fields; ?></p>
