        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-9 left">
                <ul class="breadcumbs to_hide ">
                    ...
                    <li><a href="<?php echo str_replace("?", "", site_url()); ?>"><?php echo $accueil; ?></a></li>
                ...
                <div class="row to_hide">
                    ...
                    <div class="col-sm-2 col-xs-12">
                        <a target=_blank href="javascript:;"  onclick="event.preventDefault();
                                                     document.getElementById('genratePdf').submit();">
                            <i class="fa fa-file-pdf" aria-hidden="true" style="font-size: 20px"></i>&nbsp;
                            <?php echo $version_pdf; ?>
                        </a>
                        <form action="<?php echo site_url() ?>about" id="genratePdf" method="post" style="display: none">
                            <input type="hidden" name="pdfid" value="<?php echo  $annonce->getId_ann(); ?>">
                        </form>
...
//                exit;
               ...
               <!-- <div id="map" style="width: 100%; height: 500px"></div><br> -->
					<!--Contact form-->
				        <div class="col-sm-12 col-md-12 col-lg-9" id="contact_message">

         
           
            <br>
             <form method="POST" action='<?php echo str_replace("?", "", site_url("contact/envoyer")); ?>'>
            <div class="form">
			  
                <div class="alert alert-success" id="showmsg" style="display:none;">
                   Message sent successfully. Our team contacts you soon.
                </div>
            
                
                <h4>Contact SGR Real Estate Agency Ltd</h4>
              <script>
			  window.onload=current_url;
			  function current_url()
			  {
			  document.getElementById('curl').value=window.location.href;
              var getusermsg=window.location.href;
               var showmsg = getusermsg.split("#");
               if(showmsg[1])
               {
               document.getElementById("showmsg").style.display = "block";
                ...
                <div class="row form-group">
					...
					<input type="hidden" name="proid" value="<?php echo $annonce->getId_ann(); ?>" />
                    ...
                    <div class="col-sm-6">
                        <h5>Phone *</h5>
                        <input id="prenom" type="text" name="prenom"  required class="input-custom">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-6">
                        <h5>Email </h5>
                        <input id="ad-email" type="email" name="email"  class="input-custom">
                    </div>
                    <div class="col-sm-6">
                        <h5>Address</h5>
                        <input id="fax" type="text"  name="address" class="input-custom">
                    </div>
                </div>
            </div>
            <div class="form">
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        <h5>Message *</h5>
                        <textarea class="form-control" name="message" placeholder="found this listing on SGR Real website and would like more information. Best regards" required></textarea>
                    </div>
                </div>
            </div>
...
var cururl = "<?php echo $sirurl; ?>";
    ...
    $("#convert_devise").click(function () {
        ...
        if (apres != '' && avant != '' && to_convert != '') {
            $.ajax({
                url: '<?php echo $sirurl; ?>/convert_devise',
                type: 'POST',
                dataType: 'html', // On désire recevoir du HTML
                data: {avant: avant, apres: apres, to_convert: to_convert},
                success: function (code_html, statut) { // code_html contient le HTML renvoyé
