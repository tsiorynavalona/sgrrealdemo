...
background: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url("https://sgrreal.com/assets/images/banner1.jpg");
...
<div class="homimg" style="">
	<?php
		if($this->session->userdata('site_lang') == "english"){
			echo '<div class="home-txt">Purchase, Sale, Lease <br> Property Management - Syndic <br> Partage Facilities - Heirs</div>';
		}else{
			echo '<div class="home-txt">Acht, vente, location <br> Gestion des Bien - Syndic <br> Installation de Partage - Héritiers</div>';
		}
	?>
                           ...
                           <!-- <div class="col-sm-8 col-lg-3">
                                ...
                                <map name="image-map">
                                    <area target="" alt="Rivière du Rempart" title="Rivière du Rempart"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Rivière du Rempart"), '-', true) . '/8')); ?>"
                                    ...
                                    <area target="" alt="Pamplemousses" title="Pamplemousses"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Pamplemousses"), '-', true) . '/5')); ?>"
                                    ...
                                    <area target="" alt="Port Louis" title="Port Louis"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Port Louis"), '-', true) . '/7')); ?>"
                                          coords="73,64,74,57,71,51,64,51,53,54,55,59,61,63,66,65" shape="poly">
                                    <area target="" alt="Black River" title="Black River"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Black River"), '-', true) . '/1')); ?>"
                                    ...
                                    <area target="" alt="Savanne" title="Savanne"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Savanne"), '-', true) . '/9')); ?>"
                                    ...
                                    <area target="" alt="Plaines-Wilhems" title="Plaines-Wilhems"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Plaines-Wilhems"), '-', true) . '/6')); ?>"
                                    ...
                                    <area target="" alt="Moka" title="Moka"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Moka"), '-', true) . '/4')); ?>"
                                    ...
                                    <area target="" alt="Grand Port" title="Grand Port"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Grand Port"), '-', true) . '/3')); ?>"
                                    ...
                                    <area target="" alt="Flacq" title="Flacq"
                                          href="<?php echo str_replace("?", "", site_url('region/' . url_title(convert_accented_characters("Flacq"), '-', true) . '/2')); ?>"
							...
							<div class="col-sm-8 col-lg-3">
                                ...
                                <map name="image-map">
                                    <area target="" alt="Rivière du Rempart" title="Rivière du Rempart"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=8"
                                          coords="106,50,115,46,122,43,129,41,124,33,119,25,116,14,121,8,114,4,106,3,100,0,91,1,85,10,96,17,96,30,106,38,101,41"
                                          shape="poly">
                                    <area target="" alt="Pamplemousses" title="Pamplemousses"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=5"
                                          coords="80,66,90,57,97,56,102,51,98,43,99,36,91,32,92,23,83,14,78,6,72,16,66,21,63,27,65,35,60,38,60,45,67,47,72,48,77,53,78,58"
                                          shape="poly">
                                    <area target="" alt="Port Louis" title="Port Louis"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=7"
                                          coords="73,64,74,57,71,51,64,51,53,54,55,59,61,63,66,65" shape="poly">
                                    <area target="" alt="Black River" title="Black River"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=1"
                                          coords="16,154,20,150,19,144,24,141,29,139,34,135,40,134,45,132,39,128,40,121,41,111,43,105,42,93,42,85,41,70,46,63,47,56,41,57,36,60,31,64,26,73,22,82,18,89,16,95,17,106,19,117,16,122,21,126,18,132,12,141,6,142,2,147,9,147"
                                          shape="poly">
                                    <area target="" alt="Savanne" title="Savanne"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=9"
                                          coords="22,158,28,160,36,163,44,160,49,163,56,165,64,166,69,168,75,166,82,163,89,162,93,158,90,150,83,145,77,137,79,132,70,131,62,129,56,130,54,137,46,137,40,135,28,143,23,146"
                                          shape="poly">
                                    <area target="" alt="Plaines-Wilhems" title="Plaines-Wilhems"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=6"
                                          coords="46,130,54,129,57,124,62,127,67,124,73,120,79,115,84,112,76,106,70,99,67,90,66,84,57,82,51,75,49,67,44,71,44,83,48,87,47,93,44,100,48,103,50,109,50,114,43,115,42,121,43,127,46,130"
                                          shape="poly">
                                    <area target="" alt="Moka" title="Moka"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=4"
                                          coords="74,99,77,104,84,106,92,108,103,107,105,99,108,93,105,86,101,80,102,74,106,70,101,64,95,60,86,64,79,68,70,68,64,66,56,64,52,67,53,72,56,77,62,80,67,82,71,88"
                                          shape="poly">
                                    <area target="" alt="Grand Port" title="Grand Port"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=3"
                                          coords="69,128,74,128,79,129,80,135,85,139,88,144,94,151,98,159,105,159,111,155,117,151,120,145,126,143,124,135,119,129,119,122,124,119,128,123,132,118,138,115,143,111,140,106,134,109,126,110,115,110,108,110,97,112,89,112,79,119"
                                          shape="poly">
                                    <area target="" alt="Flacq" title="Flacq"
                                          href="<?php echo site_url() ?>index.php/quickSearch?qsearch=1&reference=&id_region=2"
                                          coords="109,102,115,106,123,106,131,104,137,100,146,102,144,94,149,95,149,85,154,79,148,71,143,59,135,56,134,49,136,41,126,45,100,58,111,68,102,77,113,87"
                                          shape="poly">
                                </map>
                            </div>
