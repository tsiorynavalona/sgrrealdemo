                        ...
                        <table class="table table-hover" id="example2">
                            ...
                            <?php foreach ($caracteristiques as $car) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/detailCaracteristique/' . $car->getId_car())); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/delete_car/' . $car->getId_car())); ?>">
