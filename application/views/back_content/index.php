            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <a class="btn btn-default pull-right" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/Ajout')); ?>"><span class="glyphicon glyphicon-plus"></span>&nbsp;Ajouter</a>
                            <a class="btn btn-default pull-right" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/archive')); ?>"><span class="glyphicon glyphicon-folder-open"></span>&nbsp; Archives</a>
                        </div>
                    </div>
                    <form class="form" action="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/rechercher')); ?>">
                        <div class="row">
                            <div class="col-lg-4">
...
<!--                                <th>Agent</th>
    ...
    <!--                                    <td><?php //echo $annonce->getAgent()->getPrenom() . " " . $annonce->getAgent()->getNom();                     ?></td>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/detail/' . $annonce->getId_ann())); ?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo str_replace("?", "", site_url('back_ctrl/Annonce_Ctrl/delete_annonce/' . $annonce->getId_ann())); ?>">
                                            <span class="glyphicon glyphicon-trash"></span>
                                        </a>
                                        <a class="btn btn-xs btn-default" href="<?php echo str_replace("?", "", $href); ?>">
