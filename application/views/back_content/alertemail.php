                        ...
                        <table class="table table-hover" id="example2">
                            ...
                            <?php foreach ($alertes as $alerte) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="<?php echo str_replace("?", "", site_url('back_ctrl/Alertemail/detail/' . $alerte->getId_alerte())); ?>">
                                            <span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo str_replace("?", "", site_url('back_ctrl/Alertemail/delete/' . $alerte->getId_alerte())); ?>">
