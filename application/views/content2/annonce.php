            ...
            <div class="col-sm-12 col-md-12 col-lg-9 left">
                ...
                <div class="row to_hide">
                    ...
                    <div class="col-sm-2 col-xs-12">
                        <a target=_blank href="<?php echo str_replace("?", "", site_url("Annonce_Ctrl/createPdf/" . $annonce->getId_ann())); ?>">
...
//                exit;
                ?>
                <div class="row to_hide">
                    <div id="myCarousel20" class="col-xs-12 carousel slide" data-ride="carousel">
                        <!-- Wrapper for slides -->
