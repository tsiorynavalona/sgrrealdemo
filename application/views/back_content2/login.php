        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                    <form class="login100-form validate-form" action="<?php echo "http://patrickpatisserie.info/sgr/index.php?d=back_ctrl&c=Index&v=login";  //str_replace("?", "", site_url('back_ctrl/index/login')) ?>" method="POST">
