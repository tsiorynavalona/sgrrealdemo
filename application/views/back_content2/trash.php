            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <a class="btn btn-default pull-right" href="<?php echo site_url('back_ctrl/Annonce_Ctrl'); ?>"><span class="glyphicon glyphicon-folder-open"></span>&nbsp; Annonces</a>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <form class="form" action="<?php echo site_url('back_ctrl/Annonce_Ctrl/rechercherTrash'); ?>">
                        <div class="row">
                            <div class="col-lg-4">
...
<!--                                <th>Agent</th>
    ...
    <!--                                    <td><?php // echo $annonce->getAgent()->getPrenom() . " " . $annonce->getAgent()->getNom();             ?></td>
                                    ...
                                    <td>
                                        <a class="btn btn-xs" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/restore/' . $annonce->getId_ann()); ?>">
                                            <span ><img height="30" width="30" src="<?php echo base_url('back_assets/img/restore.png'); ?>"/></span>
                                        </a>
                                        <a class="supprimer-banque btn btn-xs btn-danger" href="<?php echo site_url('back_ctrl/Annonce_Ctrl/delete_trash/' . $annonce->getId_ann()); ?>">
