...
<div class="content-wrapper">
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <form method="POST" enctype="multipart/form-data"  action="<?php echo site_url('back_ctrl/Annonce_Ctrl/update_annonce') ?>" >
...
<script type="text/javascript">
    ...
    function del_img(id_ann, id_image) {
        if (id_ann !== 'undefined' && id_image !== 'undefined') {
            ...
            $.ajax({
                url: '<?php echo site_url('back_ctrl/Annonce_Ctrl'); ?>/del_image_annonce',
                type: 'POST',
        ...
        if (id_ann !== 'undefined') {
            ...
            $.ajax({
                url: '<?php echo site_url('back_ctrl/Annonce_Ctrl'); ?>/del_image_principal',
                type: 'POST',
                dataType: 'html', // On désire recevoir du HTML
                data: {id_ann: id_ann},
                success: function (code_html, statut) { // code_html contient le HTML renvoyé
